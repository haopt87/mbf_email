...
<script type="text/javascript">
	function submitAction(actionId) {
		...
		document.departmentlistForm.submit();
	}
</script>

<%-- <c:set var="ACTION_VIEW" value="<%= DepartmentlistAction.ACTION_VIEW %>" /> --%>
<c:set var="ACTION_VIEW" value="2" />

<html:form action="/department_mng" focus="shortname">
    ...
    <div class="grey_box_container">
        ...
        <div class="grey_box_content">
            <div class="grey_box_left_column">
                ...
                <html:text styleId="mailing_name" property="departmentName" size="42" maxlength="99"/>
            </div>

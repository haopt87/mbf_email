...
public class PreviewImageGeneratorFactoryImpl implements PreviewImageGeneratorFactory {
	...
	@Override
	public PreviewImageGenerator createPreviewImageGenerator(ApplicationContext applicationContext, HttpSession session, int previewMaxWidth, int previewMaxHeight) {
		PreviewImageGenerator previewImageGenerator = new PreviewImageGenerator(applicationContext, session, previewMaxWidth, previewMaxHeight);
		previewImageGenerator.setMediaFileManager(mediaFileManager);
		return previewImageGenerator;
	}
}

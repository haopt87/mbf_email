...
public enum Separator {
    ...
    Separator(String value, String publicValue) {
        this.value = value;
        this.publicValue = publicValue;
    }

    public static String getPublicValue(int intValue) {
        if (intValue < Separator.values().length) {
            return Separator.values()[intValue].getPublicValue();
        } else {
            return null;
        }
    }
    ...
    public static String getValue(int intValue) {
        if (intValue < Separator.values().length) {
            return Separator.values()[intValue].getValue();
        } else {
            return null;
        }
    }

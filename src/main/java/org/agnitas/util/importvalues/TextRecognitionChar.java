...
public enum TextRecognitionChar {
    ...
    TextRecognitionChar(String value, String publicValue) {
        this.value = value;
        this.publicValue = publicValue;
    }

    public static String getValue(int intValue) {
        if (intValue < TextRecognitionChar.values().length) {
            return TextRecognitionChar.values()[intValue].getValue();
        } else {
            return null;
        }
    }
    ...
    public static String getPublicValue(int intValue) {
        if (intValue < TextRecognitionChar.values().length) {
            return TextRecognitionChar.values()[intValue].getPublicValue();
        } else {
            return null;
        }
    }

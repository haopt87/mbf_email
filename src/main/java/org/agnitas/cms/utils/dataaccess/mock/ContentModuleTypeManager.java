 ...
 * org.agnitas.cms.utils.dataaccess.ContentModuleTypeManager
 *
 * @author Igor Nesterenko
 */
public interface ContentModuleTypeManager {

	ContentModuleType getContentModuleType(int id);

	List<ContentModuleType> getContentModuleTypes(int companyId, boolean includePublic);

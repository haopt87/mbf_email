 ...
 * @author mobifone
 */
public class MbfSettingSystemForm extends StrutsFormBase {

	/** The logger. */
	private static final transient Logger logger = Logger.getLogger(MbfSettingSystemForm.class);
	...
	public MbfSettingSystemForm() {
	}

	public MbfSettingSystemForm(int id, String sendEmail, String replyEmail, int deleted, int disabled) {
		super();
		this.id = id;
	...
	/**
	 * @return the autoImportTime
	 */
	public String getAutoImportTime() {
		return autoImportTime;
	}

	/**
	 * @param autoImportTime the autoImportTime to set
	 */

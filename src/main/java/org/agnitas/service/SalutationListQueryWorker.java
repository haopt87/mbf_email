 ...
 *
 */
public class SalutationListQueryWorker implements Callable<PaginatedList> {
    ...
    public SalutationListQueryWorker(TitleDao dao, @VelocityCheck int companyID, String sort, String direction, int page, int rownums ) {
		this.titleDao = dao;
		this.sort = sort;

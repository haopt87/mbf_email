...
@XmlRootElement(name = "AddMailingRequest")
public class AddMailingRequest {
    ...
    @XmlElement(required = true)
    protected AddMailingRequest.TargetIDList targetIDList;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link AddMailingRequest.TargetIDList }
     *     
     */
    public AddMailingRequest.TargetIDList getTargetIDList() {
        return targetIDList;
    }
     ...
     *     
     */
    public void setTargetIDList(AddMailingRequest.TargetIDList value) {

...
@XmlRootElement(name = "UpdateMailingRequest")
public class UpdateMailingRequest {
    ...
    @XmlElement(required = true)
    protected UpdateMailingRequest.TargetIDList targetIDList;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link UpdateMailingRequest.TargetIDList }
     *     
     */
    public UpdateMailingRequest.TargetIDList getTargetIDList() {
        return targetIDList;
    }
     ...
     *     
     */
    public void setTargetIDList(UpdateMailingRequest.TargetIDList value) {
